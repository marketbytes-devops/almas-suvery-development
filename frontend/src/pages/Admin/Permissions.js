...
const Permissions = () => {
  ...
  const pageNameMap = {
    ...
    processing_enquiries: { apiName: "processing_enquiries", displayName: "Processing Enquiries" },
    follow_ups: { apiName: "follow_ups", displayName: "Follow Ups" },
    scheduled_surveys: { apiName: "scheduled_surveys", displayName: "Scheduled Surveys" },
                      ...
                      <tr key={page} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <Input
                            type="checkbox"
                            name={`view_${page}`}
                            onChange={(e) => handlePermissionChange(page, "view")}
                        ...
                        <td className="px-4 py-3 text-center">
                          <Input
                            type="checkbox"
                            name={`add_${page}`}
                            onChange={(e) => handlePermissionChange(page, "add")}
                        ...
                        <td className="px-4 py-3 text-center">
                          <Input
                            type="checkbox"
                            name={`edit_${page}`}
                            onChange={(e) => handlePermissionChange(page, "edit")}
                        ...
                        <td className="px-4 py-3 text-center">
                          <Input
                            type="checkbox"
                            name={`delete_${page}`}
                            onChange={(e) => handlePermissionChange(page, "delete")}
